...
Sugebewa is a Rails 3 application that aims to be a simple interface for sharing
...
Requirements
------------
The requirements for running Sugebewa are:
...
Mail settings
-------------
Sugebewa sends email when users want to reset their password or when they share files.
...
In order for Sugebewa to send a user to the correct URL for either downloading a shared
...
this by uncommenting and adjusting the following line:
    ...
    # ActionMailer::Base.default :from => 'Sugebewa <yourname@yourdomain.com>'


Languages
---------
Thanks to [Rob Halff](https://github.com/rhalff), [Marcus Ilgner](https://github.com/milgner) and
[Jessica Marcon](https://github.com/marcontwm) Sugebewa is now available in Dutch, German and Italian.
...
--------------------------
If you encounter an issue with Sugebewa where downloaded files are always empty,
